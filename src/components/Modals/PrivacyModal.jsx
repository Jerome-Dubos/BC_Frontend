  ...
  return (
    ...
    >
      <div>
        <h3>Introduction</h3>
        <p>
          Bon Cours accorde une grande importance à la protection de vos données
          personnelles. Cette politique de confidentialité explique quelles
          informations nous collectons, pourquoi nous les collectons et comment
          nous les utilisons.
        </p>
        ...
        <ul>
          <li>
            <strong>Gestion des inscriptions :</strong> Traitement de votre
            demande d'inscription aux cours
          </li>
          <li>
            <strong>Suivi pédagogique :</strong> Adaptation des cours à votre
            niveau et progrès
          </li>
          <li>
            <strong>Communication :</strong> Envoi d'informations relatives à
            vos cours et notre actualité
          </li>
          <li>
            <strong>Amélioration de nos services :</strong> Analyse statistique
        ...
        <ul>
          ...
          <li>
            <strong>Obligation légale :</strong> Pour le respect des obligations
            comptables
          </li>
          <li>
            <strong>Consentement :</strong> Pour l'envoi de newsletters (avec
        ...
        <ul>
          <li>
            <strong>Données de contact :</strong> 3 ans après la fin de la
            relation commerciale
          </li>
          <li>
            <strong>Données pédagogiques :</strong> 5 ans pour le suivi des
            certifications
          </li>
          <li>
        ...
        <ul>
          ...
          <li>
            <strong>Droit d'opposition :</strong> Vous opposer au traitement à
        ...
        <p>
          ...
          fonctionnement du site et des cookies analytiques pour améliorer votre
          expérience. Vous pouvez configurer votre navigateur pour refuser les
        ...
        <p>
          ...
          modification, divulgation ou destruction. Nos serveurs sont sécurisés
          et nous utilisons le chiffrement SSL pour les transmissions de données
          sensibles.
        </p>

        <h3>Transferts de données</h3>
        <p>
          Vos données sont hébergées en France et ne font l'objet d'aucun
          transfert vers des pays tiers, sauf pour l'utilisation d'outils
          pédagogiques certifiés conformes au RGPD.
        </p>
        ...
        <div className="modal-contact">
          ...
          <p>
            ...
            <br />
            <strong>Courrier :</strong> Bon Cours - DPO, 123 Rue de l'Éducation,
            75001 Paris
            <br />
